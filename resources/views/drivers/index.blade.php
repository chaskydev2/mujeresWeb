...
<script type="text/javascript">
        ...
        if($('#driverTable .is_open:checked').length) {
            ...
            if(confirm("{{trans('lang.selected_delete_alert')}}")) {
                ...
                $('#driverTable .is_open:checked').each(async function() {
                    ...
                    await deleteDocumentWithImage('driver_users',dataId,'profilePic').then(function() {

                        deleteUserData(dataId).then(() => {
    ...
    $(document).on("click","a[name='driver-delete']",async function(e) {
        ...
        if(confirm(deleteMsg)) {
            ...
            await deleteDocumentWithImage('driver_users',id,'profilePic').then(function() {
